...
const fixture=()=>({schema_version:"1.1",adapter:"vlu_8_columns",course_count:1,needs_review:true,
  pages:[{page:1,method:"ppocr",warnings:["ocr_requires_visual_review"]}],
  courses:[{ordinal:1,course_code:"71ENG01000",course_name:"Tiếng Anh",credits:3,score_10:6,score_4:2.4,letter_grade:"C",result:"passed",source_page:1,
